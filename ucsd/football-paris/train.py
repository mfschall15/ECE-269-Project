...
if __name__ == '__main__':
    ...
    arg_dict = {
        ...
        "trained_model_path" : 'ECE-269-Project/ucsd/football-paris/kaggle_simulations/agent/model_133997184.tar', # use when you want to continue traning from given model.
